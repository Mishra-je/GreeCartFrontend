...
const Cart = () => {
    const { products, currency, CartItems, removeFromCart, getCartAmount, updateCartItem, navigate ,getCartCount,axios,User,setCartItems} = useAppContext();
    ...
    const getUserAddress = async() => {
        try {
            ...
            // console.log("Addresses are ", data)
            if(data.success){
